...
class Test3Adapter(list: MutableList<TestBean?> = ArrayList(), clickIndex: Int = -1) : BaseRecyclerViewAdapter<TestBean>(list, clickIndex) {
    init {
        setLayoutId(R.layout.item_test)
    }
